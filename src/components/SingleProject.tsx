        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 w-full pb-24 md:pb-32">
          ...
          >
            ...
            <div className="flex items-center gap-4 text-white/60">
               ...
               <p className="text-lg md:text-2xl font-light tracking-wide uppercase">{project.location}</p>
            </div>
          </motion.div>
        </div>
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <div className="md:col-span-8">
                                ...
                                <p className="text-lg md:text-2xl text-white/70 font-light leading-relaxed mb-8">
