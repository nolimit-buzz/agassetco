  ...
  return (
    <div className="bg-white min-h-screen font-sans selection:bg-ag-lime selection:text-white">
      ...
      <section className="py-24 bg-gray-50 relative overflow-hidden">
        ...
        >
          <SectionHeader number="04" category="Management" title={data.management_title} />
      ...
      <section className="py-32 bg-gray-900 text-white overflow-hidden relative">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left max-w-2xl mx-auto">
